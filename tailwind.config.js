...
module.exports = {
  ...
  theme: {
  	...
  	extend: {
      fontFamily: {
        sans: ['Figtree', 'var(--font-sans, ui-sans-serif)', 'system-ui', '-apple-system', 'BlinkMacSystemFont', '"Segoe UI"', 'Roboto', '"Helvetica Neue"', 'Arial', '"Noto Sans"', 'sans-serif', '"Apple Color Emoji"', '"Segoe UI Emoji"', '"Segoe UI Symbol"', '"Noto Color Emoji"'],
      },
  		colors: {
